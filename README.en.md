...
organizing and running daily game-automation jobs. Version 0.1.13 was released
on 2026-08-27. The project source code and the original hand-drawn project icon
...
Download the [v0.1.13 GitHub Release](https://github.com/wiwiwcwc/game-automation-control-plane/releases/tag/v0.1.13), extract the complete ZIP directory, and launch
`GameAutomationControlPlane.exe`. Keep the executable with its `_internal`
directory; do not copy out only the EXE. The repository also defines an Actions
workflow to build and upload the artifact and its SHA-256 checksum.
